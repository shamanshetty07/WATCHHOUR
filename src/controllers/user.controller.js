...
$addFields:{
 ...
 return res.status(200).json(
  new ApiResponse(200,channel[0],"user channel feteched sccessfully")
 )
})

const getWatdhHistory=asyncHandler(async(req,res)=>{
  ...
  return res.status(200),json(new ApiResponse(200,user[0].watchHistory,"watchHistory is fetched successfully"))
})

export {registerUser,loginuser,logoutUser,refreshAcessToken,changeCurrentPassword,getCurrentUser,updateAccountDetails,updateUserAvatar,updateCoverImage,getUserChannelProfile,getWatdhHistory}